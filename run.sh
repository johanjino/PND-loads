...
compile_inst(){
    llvm_inst/build/bin/clang++ -static -O3 -fcommon -gdwarf-4 -c  InstrumentationFunctionsAliasHints.cpp -o libInstrumentationFunctions.o
    llvm_inst/build/bin/llvm-ar rcs --plugin=/usr/lib/bfd-plugins/LLVMgold-18.so libInstrumentationFunctions.a libInstrumentationFunctions.o
}
# Build Gem5
build_gem5() {
    echo "Building Gem5..."
