# Install script for directory: /home/muke/Programming/PND-Loads/llvm-18/llvm/tools/llvm-nm
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "llvm-nm" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/muke/Programming/PND-Loads/llvm-18/build/bin/llvm-nm")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-nm" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-nm")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-nm"
