# Install script for directory: /home/muke/Programming/PND-Loads/llvm-18/llvm/tools/llvm-xray
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "llvm-xray" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/muke/Programming/PND-Loads/llvm-18/build/bin/llvm-xray")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-xray" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-xray")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-xray"
