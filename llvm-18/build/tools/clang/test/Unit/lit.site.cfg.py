# Autogenerated from /home/muke/Programming/PND-Loads/llvm-18/clang/test/Unit/lit.site.cfg.py.in
# Do not edit!
...
lit_config.load_config(
    config, os.path.join(path(r"/home/muke/Programming/PND-Loads/llvm-18/clang"), "test/Unit/lit.cfg.py"))
