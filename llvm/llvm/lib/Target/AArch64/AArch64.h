...
//Load alias metadata insertion pass uses these magic numbers
//for custom address spaces
...
FunctionPass *createAArch64LoadAliasMetadataInsertion();
...
void initializeAArch64LoadAliasMetadataInsertionPass(PassRegistry&);
