...
bool llvm::NullPointerIsDefined(const Function *F, unsigned AS) {
  ...
  //HACK: target dependent address space 69 is for AARCH64 that just marks loads as candidates
  //for modifying at the ISA level to get across alias information. want them to maintain
  //the same semantics.
  if (AS != 0 && AS != 69)
    return true;
